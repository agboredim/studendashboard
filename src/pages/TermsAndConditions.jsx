    ...
    <div className="max-w-3xl mx-auto py-12 px-4 text-left">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          ...
          the Company downloaded by You on any electronic device, named Titans
          Careers
        </li>
        <li>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Acknowledgment</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Subscriptions</h2>
      <h3 className="text-xl font-semibold mt-6 mb-2">Subscription period</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">Billing</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Promotions</h2>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">Content Restrictions</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">Content Backups</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Copyright Policy</h2>
      <h3 className="text-xl font-semibold mt-6 mb-2">
      ...
      <p className="mb-4">
        ...
        copyright agent via email at support@titanscareers.com and include in
      ...
      <p className="mb-4">
        ...
        support@titanscareers.com. Upon receipt of a notification, the Company
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Your Feedback to Us</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-2">Disputes Resolution</h2>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          By mail: 3rd Floor, 45, Albemarle Street, Mayfair, London, United
          Kingdom, W1S 4JL
        </li>
      </ul>
    </div>
