      ...
      <div className="py-16 px-6 md:px-12 lg:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <Mail className="h-6 w-6 text-blue-950 mr-3" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <Phone className="h-6 w-6 text-blue-950 mr-3" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <MessageSquare className="h-6 w-6 text-blue-950 mr-3" />
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <div className="flex items-start mb-6">
                  <MapPin className="h-6 w-6 text-blue-950 mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start mb-6">
                  <Clock className="h-6 w-6 text-blue-950 mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Users className="h-6 w-6 text-blue-950 mr-4 mt-1" />
                  <div>
          ...
          <div className="text-center">
            ...
            <Button className="bg-blue-950 hover:bg-blue-900 px-8 py-6 rounded-full text-lg">
