export const coursesData = [
  {
    ...
    description:
      "This comprehensive course provides a solid foundation in KYC and AML compliance, covering regulatory frameworks, customer due diligence procedures, risk assessment methodologies, and suspicious activity monitoring. Designed for compliance professionals, financial analysts, and anyone looking to enter the field of financial compliance, this course combines theoretical knowledge with practical applications to prepare you for real-world compliance challenges.",
    price: 199,
    image:
    ...
    instructorTitle: "Former Compliance Officer at HSBC",
    instructorImage:
      "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80",
    instructorBio:
      "Sarah Johnson has over 15 years of experience in financial compliance, having served as a Compliance Officer at HSBC and regulatory consultant for major financial institutions. She specializes in KYC/AML procedures and has helped numerous organizations implement robust compliance frameworks.",
    instructorCourses: 5,
    instructorStudents: 12450,
    rating: 4.8,
    reviews: 342,
    learningOutcomes: [
      "Understand the regulatory framework for KYC and AML compliance",
      ...
      "Navigate regulatory examinations and audits",
    ],
    requirements: [
    ...
    targetAudience: [
      ...
      "Anyone interested in a career in financial compliance",
    ],
    curriculum: [
      {
        title: "Introduction to KYC & AML",
        lessons: [
          {
            title: "The Importance of Financial Compliance",
            duration: "15 min",
          },
          {
            title: "History and Evolution of AML Regulations",
            duration: "25 min",
          },
          {
            title: "Key Regulatory Bodies and Their Roles",
            duration: "30 min",
          },
          { title: "Overview of the Compliance Process", duration: "20 min" },
        ],
      },
      {
        title: "Customer Due Diligence",
        lessons: [
          { title: "CDD Fundamentals", duration: "35 min" },
          { title: "Customer Identification Procedures", duration: "40 min" },
          { title: "Enhanced Due Diligence (EDD)", duration: "45 min" },
          { title: "Ongoing Monitoring Requirements", duration: "30 min" },
        ],
      },
      {
        title: "Risk Assessment Methodologies",
        lessons: [
          { title: "Risk-Based Approach to Compliance", duration: "25 min" },
          { title: "Customer Risk Profiling", duration: "35 min" },
          { title: "Geographic and Business Risk Factors", duration: "30 min" },
          { title: "Developing a Risk Assessment Matrix", duration: "40 min" },
        ],
      },
    ],
  },
